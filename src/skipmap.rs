...
pub mod tests {
    ...
    fn test_find() {
        ...
        assert_eq!(
            skm.get_greater_or_equal("ab".as_bytes()).key.as_slice(),
            "aba".as_bytes()
        );
        assert_eq!(
            skm.get_greater_or_equal("abc".as_bytes()).key.as_slice(),
            "abc".as_bytes()
        );
        assert_eq!(
            skm.get_next_smaller("abd".as_bytes()).key.as_slice(),
            "abc".as_bytes()
        );
        assert_eq!(
            skm.get_next_smaller("ab{".as_bytes()).key.as_slice(),
            "abz".as_bytes()
        );
    }
